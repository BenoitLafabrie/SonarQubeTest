...
public class StringUtils {
    ...
    private static int[] matches(final CharSequence first, final CharSequence second) {
        ...
        char[] ms1 = buildMatchedChars(min, matchIndexes, matches);
        char[] ms2 = buildMatchedChars(max, matchFlags, matches);
    ...
    private static char[] buildMatchedChars(CharSequence seq, int[] matchIndexes, int matches) {
    ...
    private static char[] buildMatchedChars(CharSequence seq, boolean[] matchFlags, int matches) {
        char[] ms = new char[matches];
        int si = 0;
