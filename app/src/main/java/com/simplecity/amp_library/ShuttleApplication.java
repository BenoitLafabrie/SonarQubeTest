...
public class ShuttleApplication extends DaggerApplication {
    ...
    private final java.util.Map<String, UserSelectedArtwork> userSelectedArtwork = new HashMap<>();
    ...
    public void onCreate() {
        ...
        // Install RxDogTag only in debug builds for tracking down crashes in beta.
    ...
    public String getVersion() {
        try {
            ...
            // Exception ignored because if version info is not found, "unknown" will be returned below.
        }
        return "unknown";
    }
    ...
    private Completable cleanMostPlayedPlaylist() {
        ...
        return Completable.fromAction(() -> {
            ...
            try {
                ...
                // Exception ignored because if the URI is invalid, there is nothing to delete.
            }
        });
    }
